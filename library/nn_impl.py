...
def _compute_sampled_logits(weights,
  ...
  with ops.name_scope(name, "compute_sampled_logits",
    ...
    print(sampled.dtype)
    print(true_expected_count.dtype)
    print(sampled_expected_count.dtype)
    ...
    if subtract_log_q:
      ...
      # dtypes.float16
      true_expected_count =  math_ops.cast(true_expected_count, dtype )
      true_logits -= math_ops.log(true_expected_count) # <-----------------------------------
      sampled_expected_count = math_ops.cast(sampled_expected_count, dtype )
